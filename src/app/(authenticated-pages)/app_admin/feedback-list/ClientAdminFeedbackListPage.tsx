...
export function ClientAdminFeedbackListPage({
    ...
    const {
        data: feedbackList,
        isLoading,
    } = useQuery(['appAdminGetAllInternalFeedback', debouncedSearchText, filters], () => {
                                        ...
                                        onClick={() =>
                                            setFilters({
                                                ...
                                                statuses: filters.statuses?.includes(statusOption)
                                                    ? filters.statuses.filter((status) => status !== statusOption)
                                        ...
                                        onClick={() =>
                                            setFilters({
                                                ...
                                                priorities: filters.priorities.includes(priorityOption)
                                                    ? filters.priorities.filter((priority) => priority !== priorityOption)
                            ...
                            <tr className="p-0" key={feedback.id}>
                                <td className="p-0 ">
                                    <TableCell classname="px-6 py-4 truncate">
                                        <AdminViewUserDetails userId={feedback.user_id} adminGetUser={adminGetUser} />
                                    </TableCell>
                                </td>
                                <td className="p-0 ">
                                    <Anchor
