...
export default async function AppAdminFeedbackItemPage({
  ...
  const [feedbackThread, comments] = await Promise.all([
    getInternalFeedbackById(supabaseAdminClient, feedbackId),
    getInternalFeedbackComments(supabaseAdminClient, feedbackId),
  ]);
