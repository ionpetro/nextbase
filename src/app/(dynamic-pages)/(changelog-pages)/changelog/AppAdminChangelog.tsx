...
type Props = {
  changelog: Tables<'internal_changelog'>;
  isLastAdded: boolean;
};

export const AppAdminChangelog = ({ changelog, isLastAdded }: Props) => {
  return (
    <div className="grid-cols-5 grid gap-4 mx-auto md:p-8 max-w-4xl">
      <div className="flex flex-col mb-8 col-span-1 gap-2">
        ...
        {isLastAdded && <Badge className="mr-2 p-2 px-4 w-fit">NEW</Badge>}
      </div>
