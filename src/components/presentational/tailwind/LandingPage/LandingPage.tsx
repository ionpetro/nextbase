...
const features = [
  ...
  },
  {
    ...
    description: (
      <>
        ...
        which you can use to build and send emails to your users. You can
        configure third-party email providers like SendGrid, Postmark and any
        providers that ReactEmail supports.
      </>
    ),
  },
  {
  ...
  {
    name: 'Low code Database Management',
    description:
  ...
  },
  {
    ...
    description: (
      <>
        Nextbase comes with clean and simple to follow{' '}
        <Anchor
          href="https://docs.usenextbase.com"
          target="_blank"
          className="text-blue-500 underline"
        >
          documentation
        </Anchor>
        . If you find anything missing, however, please reach out to us and will
        improve the docs!
      </>
    ),
  },
  {
    name: 'Clean Typesafe codebase',
    description:
  ...
  {
    name: 'React Query setup built-in',
    description:
    ...
    <header>
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <a
            href="https://ultimate-demo.usenextbase.com"
      ...
      <div className="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="place-self-center mr-auto lg:col-span-7">
          <h1 className="mb-4 max-w-2xl text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl dark:text-white">
            Build SAAS products in record time
          </h1>
          <p className="mb-6 max-w-2xl font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
            The fastest way to build your next SaaS product. Start with a
            powerful Next.js 13, Supabase and Stripe boilerplate and launch your
            product in a week!
          </p>
          <Anchor
            href="/login"
        ...
        <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
          <img src="/mockups/laptop.jpeg" alt="mockup" />
        </div>
      </div>
    </section>
    <section className="bg-white dark:bg-gray-900">
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="mb-8 max-w-screen-md lg:mb-16">
          ...
          <p className="text-gray-500 sm:text-xl dark:text-gray-400">
            From database management to payment processing, customer account
            management and more, Nextbase has all the tools you need.
          </p>
        </div>
    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
          ...
          <p className="mb-4">
            Every professional SAAS product requires common features like
            authentication, billing, and user management. We've built these
            features into our boilerplate so you can focus on your product.
          </p>
          <p>
            We love to build products quickly and we built NextBase for
            ourselves and for the SAAS community to build quality products
            faster.
          </p>
        </div>
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-2xl sm:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md text-center">
          <h2 className="mb-4 text-4xl font-extrabold leading-tight text-gray-900 dark:text-white">
            Don't waste time building authentication, settings or payments!
          </h2>
          <p className="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">
            Using NextBase you can launch your SAAS in no time because we give
            you all of that and more out of the box. Just focus on building your
            core product.
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="https://usenextbase.com" className="flex items-center">
              <img
                src="https://usenextbase.com/logos/nextbase/Logo%2006.png"
                className="mr-3 h-8"
                alt="NextBase Logo"
