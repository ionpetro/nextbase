        ...
        {isDemo ?
          <HoverCard>
            ...
            <HoverCardContent className="w-80 bg-slate-900">
              <T.Small className="text-slate-50">⚠️ As this is a demo, the social media authentication buttons aren't linked. However, you can connect them in your dev environment using the supabase dashboard for your project.</T.Small>
            </HoverCardContent>
          </HoverCard>
